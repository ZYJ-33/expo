...
@0 = private unnamed_addr constant [4 x i8] c"w\D6\88>"
@1 = private unnamed_addr constant [4 x i8] c"w\D6\08\BE"

define void @fusion(ptr noalias align 16 dereferenceable(672) %arg0, ptr noalias align 128 dereferenceable(672) %arg1) {
entry:
...
fusion.in_bounds-true:                            ; preds = %entry
  ...
  %multiply.6 = fmul float %6, %region_0_8_constant_4
