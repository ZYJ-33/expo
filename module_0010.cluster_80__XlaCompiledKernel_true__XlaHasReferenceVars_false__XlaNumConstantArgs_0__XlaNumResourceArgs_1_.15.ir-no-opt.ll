...
@0 = private unnamed_addr constant [4 x i8] c"\1D\A0s>"
@1 = private unnamed_addr constant [4 x i8] c"\1D\A0\F3\BD"

define void @fusion(ptr noalias align 16 dereferenceable(172032) %arg0, ptr noalias align 128 dereferenceable(172032) %arg1) {
entry:
