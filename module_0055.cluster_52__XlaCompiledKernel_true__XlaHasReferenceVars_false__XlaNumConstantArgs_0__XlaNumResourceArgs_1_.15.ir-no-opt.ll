...
@0 = private unnamed_addr constant [4 x i8] c"\04\EC\1F>"
@1 = private unnamed_addr constant [4 x i8] c"\04\EC\9F\BD"

define void @fusion(ptr noalias align 16 dereferenceable(61952) %arg0, ptr noalias align 128 dereferenceable(61952) %arg1) {
entry:
