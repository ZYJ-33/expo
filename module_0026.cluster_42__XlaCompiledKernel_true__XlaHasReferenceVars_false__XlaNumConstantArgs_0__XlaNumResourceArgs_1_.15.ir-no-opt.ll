...
@0 = private unnamed_addr constant [4 x i8] c"\A2\F8#>"
@1 = private unnamed_addr constant [4 x i8] c"\A2\F8\A3\BD"

define void @fusion(ptr noalias align 16 dereferenceable(115712) %arg0, ptr noalias align 128 dereferenceable(115712) %arg1) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !2
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !3
  %2 = mul nuw nsw i32 %0, 1024
  %linear_index = add nuw nsw i32 %2, %1
  %linear_index_in_range = icmp ult i32 %linear_index, 29696
  call void @llvm.assume(i1 %linear_index_in_range)
  %3 = udiv i32 %linear_index, 1
  %4 = urem i32 %3, 32
  %5 = udiv i32 %linear_index, 32
  %6 = icmp ult i32 %linear_index, 28928
