...
@0 = private unnamed_addr constant [4 x i8] c"\91\FD[>"
@1 = private unnamed_addr constant [4 x i8] c"\91\FD\DB\BD"

define void @fusion(ptr noalias align 16 dereferenceable(16384) %arg0, ptr noalias align 128 dereferenceable(16384) %arg1) {
entry:
