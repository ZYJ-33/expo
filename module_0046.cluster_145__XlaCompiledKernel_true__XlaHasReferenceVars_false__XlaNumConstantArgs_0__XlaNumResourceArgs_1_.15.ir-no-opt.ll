...
@1 = private unnamed_addr constant [4 x i8] c"\9B\E8\A1\BD"

define void @fusion(ptr noalias align 16 dereferenceable(917504) %arg0, ptr noalias align 128 dereferenceable(917504) %arg1) {
entry:
