...
@0 = private unnamed_addr constant [4 x i8] c"\C0zW>"
@1 = private unnamed_addr constant [4 x i8] c"\C0z\D7\BD"

define void @fusion_2(ptr noalias align 16 dereferenceable(61440) %arg0, ptr noalias align 16 dereferenceable(61440) %arg1, ptr noalias align 128 dereferenceable(61440) %arg2, ptr noalias align 128 dereferenceable(61440) %arg3) {
entry:
