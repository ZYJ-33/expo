...
@0 = private unnamed_addr constant [4 x i8] c"\A3\AEX>"
@1 = private unnamed_addr constant [4 x i8] c"\A3\AE\D8\BD"

define void @fusion(ptr noalias align 16 dereferenceable(49152) %arg0, ptr noalias align 128 dereferenceable(49152) %arg1) {
entry:
